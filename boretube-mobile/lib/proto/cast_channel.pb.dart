...
//
// Generated from proto/cast_channel.proto.
...
class CastMessage extends $pb.GeneratedMessage {
  ...
  factory CastMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CastMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  set protocolVersion(CastMessage_ProtocolVersion value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class AuthChallenge extends $pb.GeneratedMessage {
  ...
  factory AuthChallenge.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AuthChallenge.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AuthResponse extends $pb.GeneratedMessage {
  factory AuthResponse({
    ...
    if (clientAuthCertificate != null) result.clientAuthCertificate = clientAuthCertificate;
    return result;
  }
  ...
  @$pb.TagNumber(2)
  set clientAuthCertificate($core.List<$core.int> value) => $_setBytes(1, value);
  @$pb.TagNumber(2)
...
class DeviceAuthMessage extends $pb.GeneratedMessage {
  ...
  factory DeviceAuthMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DeviceAuthMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
