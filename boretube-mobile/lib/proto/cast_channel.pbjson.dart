...
final $typed_data.Uint8List authResponseDescriptor = $convert.base64Decode(
    ...
    'F1dGhfY2VydGlmaWNhdGUYAiACKAxSFWNsaWVudEF1dGhDZXJ0aWZpY2F0ZQ==');
...
const AuthError_ErrorType$json = {
  ...
  '2': [
    ...
    {'1': 'NO_TLS', '2': 1},
    {'1': 'SIGNATURE_ALGORITHM_UNAVAILABLE', '2': 2},
  ],
};
...
final $typed_data.Uint8List authErrorDescriptor = $convert.base64Decode(
    ...
    'hhbm5lbC5BdXRoRXJyb3IuRXJyb3JUeXBlUgllcnJvclR5cGUiUAoJRXJyb3JUeXBlEhIKDklO'
    'VEVSTkFMX0VSUk9SEAASCgoGTk9fVExTEAESIwofU0lHTkFUVVJFX0FMR09SSVRITV9VTkFWQU'
    'lMQUJMRRAC');
